...
`folio_source_record.marc_records_lb` to a tabular form which is stored in a
new table `folio_source_record.marctab`.  This transformation runs
automatically, usually every few hours.  The time of the most recent update can
be retrieved via SQL:
