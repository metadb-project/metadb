...
have some https://dev.folio.org/reference/api/[documentation for
"storage module" WSAPIs] which are roughly equivalent.  The names of
most storage modules end in `-storage`, but some modules use a
